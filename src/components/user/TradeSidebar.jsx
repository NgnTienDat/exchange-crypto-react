...
//       time: new Date(data.tradeTime).toLocaleTimeString(), // hiển thị HH:mm:ss
//       type: data.isBuyer ? 'buy' : 'sell',
//     };

//     setRecentTrades((prev) => {
//       const updated = [newTrade, ...prev];
//       return updated.slice(0, 30); // giữ lại 30 trade mới nhất
//     });
//   });
        ...
        <div className="mb-6">
          ...
          <div className="space-y-1 text-xs">
            ...
            {recentTrades.map((trade, index) => (
              ...
              >
                {/* Sử dụng Intl.NumberFormat để format số cho đẹp hơn */}
