...
export const endpoints = {
  ...
  totalOrdersToDay: "/api/orders/admin/stats/today/count",
  totalOrdersMoth: "/api/orders/admin/stats/month/count",
  totalOrdersYear: "/api/orders/admin/stats/year/count",
  allOrders: "/api/orders/all",
  allTrades: "/api/trades",
  adminOrderBook: "/api/orders/admin/order-book",
