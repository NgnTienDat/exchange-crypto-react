    ...
    <div className="flex items-center justify-center">
      <div className="w-96 bg-gray-800 rounded-2xl p-6 shadow-2xl border border-gray-700">
        ...
        <div className="space-y-4">
          {/* Email Input */}
          <div>
            <label className="block text-gray-300 text-md mb-2">
              Email
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-700 text-white placeholder-gray-500 rounded-lg 
                  px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all border border-gray-600"
              />
              <button
                type="button"
